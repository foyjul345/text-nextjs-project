...
//             return NextResponse.json({message : "Missing required fiels : articleId and comment"},{status : 400})
//          }
...
//             content : content
//         }
//     const updateComment = await CommentModel.findByIdAndUpdate(parentId, {$push : {replyText : newReply}},
//         {new : true})
...
//         } catch (error : any) {
//         console.error("Error in Post Commentin '/api/comments': ",error)
//             return NextResponse.json({message :"Failed to process comment.",details :error.message},{status : 500})
//     }
