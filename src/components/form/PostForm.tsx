...
//     author: string;
//     content: string;
//     category: "Tech" | "Design" | "Health" | "Lifestyle" | "Education" | "Startup" | "Culture" | "Politics" | "";
//     excerpt: string;
//     image?: string;
//     tags: string;
//     status: boolean
...
//     const [exitingImage,setExitingImage] = React.useState<string  | null>(initialData?.image || null)

//     useEffect(() => {
//         if(initialData?.image){
//             setExitingImage(initialData.image)
//         }
//     },[initialData])



//     const onFrormSubmit = (data: PostFormType) => {
//         onSubmit(data, imageFile); // Pass the imageFile to the onSubmit function
//     }
//     return (
//         <form onSubmit={handleSubmit(onFrormSubmit)} className='space-y-6 max-w-3xl'>
//             {/* title */}
//             <div>
...
//                     <option value="ech" disabled>Select Category</option>
...
//                 />
//                 {errors.excerpt && <p className='text-red-600'>{errors.excerpt.message}</p>}
//             </div>
//             {/* Image */}
//             <div>
//                 <label className='block font-bold mb-1'>Image Upload <span className='text-red-500'>*</span></label>
//                 <input
//                     id='image'
//                     accept='imag/*'
//                     type="file"
...
//                     className='w-full border file:rounded-full mt-1 text-sm text-gray-500 file:px-4 file:py-2 file:border-0 cursor-pointer
//                     file:text-sm file:font-semibold file:bg-indigo-500 file:text-white hover:file:bg-indigo-600 file:hover:text-white'

//                 />
//                 {
//                     imageFile && (
//                         <Image src={URL.createObjectURL(imageFile) } alt={"Image Preview"} className='mt-2 max-h-40 border 
//                         object-contain' width={200} height={200} priority/>
//                     )
//                 }

//                 {
//                     !imageFile && exitingImage && (
//                         <Image src={exitingImage } alt={"Image Preview"} className='mt-2 max-h-40 border 
//                         object-contain' width={200} height={200} priority/>
//                     )
//                 }
//             </div>
